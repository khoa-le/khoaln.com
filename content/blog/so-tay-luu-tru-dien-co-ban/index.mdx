  ...
  <table className="min-w-full min-w-[800px]">
    <thead>
      <tr>
        ...
        <th className="min-w-[150px]">Dung lượng Lý thuyết</th>
        <th className="min-w-[150px]">Dung lượng Thực tế (Khả dụng)</th>
        <th className="min-w-[150px]">Khả năng chịu tải (Công suất đầu ra)</th>
        <th className="min-w-[200px]">Khả năng "gánh" thiết bị tham khảo (Sạc đầy)</th>
      </tr>
    </thead>
    <tbody>
      <tr>
